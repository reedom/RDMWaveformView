...
public struct WaveformTimeGuageRendererParams {
...
public class WaveformTimeGuageRenderer {
  private let params: WaveformTimeGuageRendererParams

  public init(params: WaveformTimeGuageRendererParams) {
    self.params = params
  }
...
public class WaveformTimeGuageView: UIView {
  ...
  private var activeViews = [WaveformTimeGuageUnitView]()
  /// A object pool of deactive unit views.
  private var deactiveViews = [WaveformTimeGuageUnitView]()
}

extension WaveformTimeGuageView {
  ...
  private func createUnitView() -> WaveformTimeGuageUnitView {
    let unitView = WaveformTimeGuageUnitView()
    addSubview(unitView)
...
class WaveformTimeGuageUnitView: UIView {
  var timeRange: TimeRange!
  var rendererParams: WaveformTimeGuageRendererParams!

  override func draw(_ rect: CGRect) {
    guard let context = UIGraphicsGetCurrentContext() else { return }
    let renderer = WaveformTimeGuageRenderer(params: rendererParams)
