...
public struct WaveformCalc {
  ...
  public let resolution: WaveformResolution
  ...
  public init(audioContext: AudioContext,
    ...
    self.duration = audioContext.asset.duration.seconds
    self.sampleRate = audioContext.sampleRate
...
extension WaveformCalc {
  static func ==(lhs: WaveformCalc, rhs: WaveformCalc) -> Bool {
    return lhs.audioContext == rhs.audioContext && lhs.resolution == rhs.resolution && lhs.totalWidth == rhs.totalWidth
  }
